...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.iqera.cop.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.iqera.cop.repository.UserRepository.USERS_BY_EMAIL_CACHE);
