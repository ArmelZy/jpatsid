...
import com.iqera.cop.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link com.iqera.cop.domain.ShoppingCart}.
 */
@RestController
...
public class ShoppingCartResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ShoppingCart>> getAllShoppingCarts(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
