...
import com.iqera.cop.domain.enumeration.Gender;
import com.iqera.cop.repository.CustomerDetailsRepository;
import com.iqera.cop.service.CustomerDetailsService;
...
class CustomerDetailsResourceIT {
    ...
    @Test
    @Transactional
    void updateCustomerDetailsMapsIdAssociationWithNewId() throws Exception {
        ...
        assertThat(updatedCustomerDetails).isNotNull();
